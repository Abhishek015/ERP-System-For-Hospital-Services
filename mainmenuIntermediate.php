...
<li id="doctorappointment" class="active"><a href="../Doctor2/index.php" class="btn btn-info">Doctor Appointment System</a></li>
<li id="hospitalbedbooking" class="active"><a href="hospital_bed_booking.php" class="btn btn-info"> Hospital Bed Booking</a></li>
<li id="medicalstore" class="active"><a href="../Medi-Store/ecommerce.php" class="btn btn-info">Online Store</a></li>
